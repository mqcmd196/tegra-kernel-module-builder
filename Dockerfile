...
RUN apt update && apt install -y -qq emacs git
RUN rm -rf /var/lib/apt/lists/*
 
RUN cd /l4t && tar -I lbzip2 -xf targetfs.tbz2 && mkdir toolchain && tar -C toolchain -xf toolchain.tar.gz
 
COPY public_sources.tbz2 /l4t
RUN cd /l4t && tar xvf public_sources.tbz2
